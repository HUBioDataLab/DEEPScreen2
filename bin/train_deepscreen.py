...
def train_validation_test_training(target_id, model_name, fully_layer_1, fully_layer_2, learning_rate, batch_size, drop_rate, n_epoch, experiment_name, cuda_selection):
    ...
    # Systems have different floating point precision for scientifing notation (e notation)
    ...
    # To log loss (graphical)
    writer = SummaryWriter(comment = str_arguments+"_"+str(cuda_selection))
